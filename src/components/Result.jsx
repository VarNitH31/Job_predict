		...
		<>
			...
			<div className="mt-16 bg-blue-100  border border-blue-400 text-blue-700 px-6 py-3 rounded w-fit mx-auto flex flex-col justify-center items-center">
				<p className="text-lg font-poppins">
					Interested in {prediction} roles? Check out these openings
					on LinkedIn:
				</p>
			</div>
			<div className="flex w-2/5 mx-auto my-28 border  border-blue-500 py-5 px-7 justify-between rounded-md hover:bg-blue-400 shadow-black hover:shadow-lg hover:-translate-y-1 hover:text-white transition-all ">
				<svg
